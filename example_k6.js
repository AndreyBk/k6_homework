...
// Мы создаем их перед нашей основной функцией
...
export default function() {
    ...
    group("Front page", function() {
        ...
        // Запишите время до первого байта и пометьте его URL-адресом, чтобы иметь возможность фильтровать результаты в Insights.
